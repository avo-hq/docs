...
If you have a 1.0 license and want to upgrade to 2.0 you need to log in to [avohq.io]() and hit the `Upgrade` button next to your license. You'll be redirected to the new subscription screen where you can start the subscription for 2.0.
